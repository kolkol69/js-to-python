...
// Visit a parse tree produced by ECMAScriptParser#ForLetStatement.
ECMAScriptVisitor.prototype.visitForLetStatement = function(ctx) {
  return this.visitChildren(ctx);
};


// Visit a parse tree produced by ECMAScriptParser#ForConstStatement.
ECMAScriptVisitor.prototype.visitForConstStatement = function(ctx) {
  return this.visitChildren(ctx);
};
...
// Visit a parse tree produced by ECMAScriptParser#ForLetInStatement.
ECMAScriptVisitor.prototype.visitForLetInStatement = function(ctx) {
  return this.visitChildren(ctx);
};


// Visit a parse tree produced by ECMAScriptParser#ForConstInStatement.
ECMAScriptVisitor.prototype.visitForConstInStatement = function(ctx) {
  return this.visitChildren(ctx);
};
